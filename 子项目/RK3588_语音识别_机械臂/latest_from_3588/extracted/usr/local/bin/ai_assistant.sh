...
export ASR_BACKEND=${ASR_BACKEND:-auto}
export AI_VOICE_GAIN=${AI_VOICE_GAIN:-5.0}
export AI_TRIGGER_PEAK=${AI_TRIGGER_PEAK:-0.038}
export AI_SILENCE_PEAK=${AI_SILENCE_PEAK:-0.022}
export AI_MIN_RECORD_SEC=${AI_MIN_RECORD_SEC:-0.46}
export AI_MAX_RECORD_SEC=${AI_MAX_RECORD_SEC:-5.2}
export AI_POST_SILENCE_SEC=${AI_POST_SILENCE_SEC:-0.78}
export AI_FAST_POST_SILENCE_SEC=${AI_FAST_POST_SILENCE_SEC:-0.52}
export AI_NOISE_TRIGGER_MULT=${AI_NOISE_TRIGGER_MULT:-1.25}
export AI_NOISE_SILENCE_MULT=${AI_NOISE_SILENCE_MULT:-1.05}
export AI_MAX_DYNAMIC_TRIGGER=${AI_MAX_DYNAMIC_TRIGGER:-0.095}
export AI_MAX_DYNAMIC_SILENCE=${AI_MAX_DYNAMIC_SILENCE:-0.060}
